...
*/
function CharacterStats(CharStateAttr){
  GameObject.call(this, CharStateAttr);
  this.healthPoints = CharStateAttr.healthPoints;
  
}// char state
CharacterStats.prototype = Object.create(GameObject.prototype); //inherit destroy() from GameObject's prototype
